...
f# Get the website that contains classes and IDs.
...
# Get the Superbowl box score data# Get the Superbowl box score data.
...
seahawk_total_yards = total_yards.select("td")[1]
seahawks_total_yards_count = seahawk_total_yards.text