...
params_1 = {"per_page": 50, "page": 2}
response =requests.get('https://api.github.com/users/VikParuchuri/starred', headers=headers, params=params_1)
...
response = requests.post('https://api.github.com/user/repos', json=payload1, headers=headers)
...
response = requests.patch('https://api.github.com/repos/VikParuchuri/learning-about-apis', json=payload1, headers=headers)
status = response.status_code 
